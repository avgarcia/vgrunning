...
/**
 * Verifica que la aplicación conserva los ocho módulos y el grafo de dependencias aceptado en ADR-0014.
 */
class ApplicationModularityTest {
    ...
    /** Comprueba que Spring Modulith no detecta ciclos ni accesos a paquetes internos entre módulos reales. */
    @Test
    void verifiesTheAcceptedModuleBoundaries() {
        assertThatCode(MODULES::verify).doesNotThrowAnyException();
    }

    /** Comprueba que el análisis descubre exactamente los ocho módulos acordados, sin módulos accidentales. */
    @Test
