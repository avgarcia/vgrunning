...
/**
 * Fixture que viola intencionadamente el límite modular al importar un tipo interno de {@code source}.
 *
 * <p>La prueba {@code InvalidModuleStructureTest} exige que Spring Modulith rechace esta dependencia.</p>
 */
