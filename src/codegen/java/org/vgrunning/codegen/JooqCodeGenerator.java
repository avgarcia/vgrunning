 ...
 *
 * <p>Se ejecuta exclusivamente durante el build, en desarrollo o CI, contra PostgreSQL efímero. No
 * forma parte del {@code bootJar}, no arranca contenedores en el entorno desplegado y no se ejecuta
...
public final class JooqCodeGenerator {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length != 1) {
            throw new IllegalArgumentException(
                    "Se esperaba el directorio de salida como único argumento.");
        }
    ...
    /**
     * Inspecciona los ocho esquemas técnicos ya migrados y escribe los tipos jOOQ fuera del código
     * fuente versionado.
     *
     ...
     */
    private static void generate(PostgreSQLContainer postgres, Path targetDirectory)
            throws Exception {
        List<SchemaMappingType> schemaMappings =
                SCHEMAS.stream()
                        .map(
                                schema ->
