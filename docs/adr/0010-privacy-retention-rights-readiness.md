...
**Validación documental:** Superada el 2026-08-13; aceptación y producción bloqueadas
...
7. análisis de riesgos y decisión documentada sobre si procede una EIPD;
...
El producto no ofrecerá decisiones automatizadas con efectos jurídicos, perfilado comercial ni inferencias de salud. El comentario de seguimiento mostrará una instrucción visible para no introducir diagnósticos, lesiones ni otra información de salud. Esa advertencia reduce recogida accidental, pero no elimina el riesgo ni constituye una base jurídica.
...
El comentario libre de seguimiento se mantiene condicionado a que el responsable documente antes de producción una base jurídica y, cuando corresponda, una condición y garantías válidas para posibles datos de salud. Si la revisión de privacidad concluye que no existe una solución defendible, el comentario se eliminará del alcance antes de recoger seguimiento.

La matriz mínima de conservación será:

| Categoría | Evento inicial | Plazo | Acción ordinaria al vencer |
| --- | --- | --- | --- |
| Cuenta, perfil y clasificación | Fin de la relación con el club | `30` días | Suprimir cuenta, correo, perfil, etiquetas, grupos y excepciones. |
| Planes publicados y seguimiento | Fecha del entrenamiento | `24` meses | Suprimir o anonimizar irreversiblemente según la finalidad aprobada. |
| Notificaciones | Estado técnico final | `90` días | Suprimir destino, contenido y detalle de entrega no necesario. |
| Invitaciones y recuperaciones | Uso o caducidad | `30` días | Suprimir verificadores y metadatos asociados. |
| Auditoría y seguridad | Fecha del evento | `12` meses | Suprimir salvo bloqueo documentado por incidente o reclamación. |
| Copias de respaldo | Creación de la copia | Máximo `35` días | Destruir la copia completa mediante rotación verificable. |
...
Todo proveedor con acceso o capacidad de tratamiento será inventariado antes de contratarse o habilitarse. El responsable aprobará el encargo, subencargados, ubicación, eliminación o devolución al terminar y asistencia para derechos, incidentes y auditoría. Las transferencias internacionales no se inferirán de la marca comercial del proveedor; se documentarán según la región y garantías efectivas del servicio contratado.
...
Antes de producción se realizará un análisis de riesgos con los tratamientos reales y proveedores elegidos. El responsable documentará si procede una EIPD; si procede, deberá completarse antes del tratamiento e incluir descripción, necesidad y proporcionalidad, riesgos y medidas. Una conclusión de que no procede también quedará razonada y se revisará ante cambios significativos.
...
- Actualmente no existe contacto de privacidad ni está identificada en el ADR la entidad jurídica responsable, por lo que producción y aceptación permanecen bloqueadas.
...
- Documentar análisis de riesgos y decisión sobre EIPD; completar y aprobar la EIPD cuando proceda.
- Obtener revisión humana de privacidad antes de autorizar producción.

## Resultado de validación documental

La revisión documental del 2026-08-13 concluye:
...
- decisiones pendientes clasificadas con responsable y tratamiento.

Esta validación no acepta el ADR, no aprueba bases jurídicas, no constituye revisión legal o de privacidad y no autoriza producción. El estado permanece `Propuesto` hasta resolver todos los bloqueos para aceptar. Incluso después de aceptarlo, la producción seguirá bloqueada hasta aportar las evidencias específicas indicadas en este ADR.

## Decisiones pendientes

- **Bloqueante para aceptar:** identificar la persona física o jurídica responsable del tratamiento y sus datos de contacto. Actualmente no existe una identidad responsable definida para el PMV. Responsable: propietario del futuro servicio. Tratamiento: constituir o designar la identidad real antes de aceptar este ADR.
- **Bloqueante para aceptar:** crear la dirección específica de privacidad e identificar su responsable operativo. Actualmente no existe. Responsable: responsable del tratamiento. Tratamiento: documentar canal y propietario antes de aceptar.
- **Bloqueante para aceptar:** aprobar finalidades y base jurídica por categoría; documentar específicamente la condición y garantías para posibles datos de salud en comentarios. Responsable: responsable del tratamiento con asesoramiento de privacidad. Tratamiento: revisar antes de aceptar y eliminar el comentario si no existe una solución defendible.
- **Bloqueante para aceptar:** revisar jurídicamente la matriz de conservación aprobada y confirmar si alguna obligación o plazo de reclamación exige bloqueo en lugar de supresión. Responsable: responsable del tratamiento con asesoramiento de privacidad. Tratamiento: validar cada fila antes de aceptar.
- **Bloqueante para producción:** inventariar encargados y subencargados reales, regiones y transferencias al elegir identidad, hosting, correo, observabilidad y copias. Responsable: responsable del tratamiento y revisor de arquitectura. Tratamiento: completar contratos y garantías antes de habilitar cada proveedor.
- **Bloqueante para producción:** realizar el análisis de riesgos con el stack y proveedores reales y documentar si procede una EIPD. Responsable: responsable del tratamiento con asesoramiento de privacidad o DPO cuando exista. Tratamiento: completar antes de producción y revisar ante cambios significativos.
- **Bloqueante para producción:** aprobar información de privacidad, registro de actividades, procedimiento de derechos, retención automática, gestión de brechas y medidas técnicas y organizativas. Responsable: responsable del tratamiento. Tratamiento: aportar evidencia y revisión humana antes de producción.
