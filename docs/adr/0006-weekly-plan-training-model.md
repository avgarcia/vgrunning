...
**Refinado parcialmente por:** [ADR-0020](0020-planning-lifecycle-objectives-history.md)
...
- **Resuelto por `ADR-0020`:** ciclo de vida de grupos, reconfiguración multigrupo, modalidad del entrenamiento, escalas de objetivos, concurrencia del borrador, historial y retención.
