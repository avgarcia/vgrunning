...
- **Tratado por `ADR-0015` (Propuesto):** mecanismo reactivo de políticas, propagación del actor y alcance por recurso. La decisión no se considera cerrada hasta aceptar ese ADR.
