...
- **Tratado por `ADR-0015` (Propuesto):** mecanismo de políticas, propagación explícita del actor y alcance por recurso. La decisión no se considera cerrada hasta aceptar ese ADR.
