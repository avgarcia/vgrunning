...
| [ADR-0013](0013-reactive-application-runtime-framework.md) | Runtime reactivo, framework de aplicación y contrato API | Propuesto | Todos los `RF` |
| [ADR-0014](0014-modular-hexagonal-ddd-architecture.md) | Arquitectura modular, hexagonal y DDD selectivo | Propuesto | Todos los `RF` |
| [ADR-0015](0015-reactive-application-authorization-enforcement.md) | Aplicación reactiva de autorización y alcance por recurso | Propuesto | `RF-02`, `RF-03`, `RF-05` a `RF-09`, `RF-14` y `RF-16` a `RF-19` |
