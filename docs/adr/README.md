...
| [ADR-0013](0013-application-runtime-framework.md) | Runtime imperativo, framework de aplicación y contrato API | Propuesto | Todos los `RF` |
...
| [ADR-0015](0015-application-authorization-enforcement.md) | Aplicación de autorización y alcance por recurso | Propuesto | `RF-02`, `RF-03`, `RF-05` a `RF-09`, `RF-14` y `RF-16` a `RF-19` |
