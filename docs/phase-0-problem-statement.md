# Declaración del problema — Gestión de entrenamientos del club de corredores
...
El club gestiona más de 500 alumnos en dos modalidades: entrenamiento en línea y entrenamiento presencial en el Retiro, dirigido por uno de los entrenadores. Hoy los planes se distribuyen como PDF por correo electrónico; la comunicación se realiza por correo o WhatsApp.
...
| Modalidades | En línea y presencial en el Retiro |
...
| Seguimiento inicial | Información de seguimiento declarada por el corredor |
| Presencial | Mismo flujo de entrenamiento que en línea, añadiendo lugar de encuentro |
...
- No se ha definido el detalle de la información de seguimiento, sus escalas, ni cómo se convierte en decisiones para el entrenador.
...
- **Riesgo medio:** definir “analizar la información de seguimiento” de forma vaga puede producir una bandeja de comentarios inútil; será necesario concretar qué información se pide y qué decisiones habilita.
...
- El entrenador podrá revisar la información de seguimiento de sus corredores sin intervención administrativa adicional.
