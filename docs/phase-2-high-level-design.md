...
| --- | --- | --- |
| `D-01` | Taxonomías, segmentos, excepciones, versión y destinatarios efectivos. | `ADR-0005` (Propuesto), `ADR-0007` |
| `D-02` | Modalidad dentro de la taxonomía controlada. | `ADR-0005` (Propuesto) |
...
| `D-05` | Gramática limitada de reglas de segmentos. | `ADR-0005` (Propuesto) |
...
| `ADR-0005`: taxonomías y segmentación | Modelo de datos y semántica de destinatarios. | Implementar administración o segmentación. | Revisor de arquitectura | Propuesto; confirmar cardinalidad y protección de modalidad antes de aceptar. |
