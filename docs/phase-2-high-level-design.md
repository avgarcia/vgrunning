...
| `RF-02` | Administración; Identidad, Gestión de corredores y Clasificación | Rol inicial inmutable, perfil de corredor y taxonomías cerradas administrados solo por administrador; modificar roles queda descartado en Fase 2. | `D-01`, `D-08` | `ADR-0003`, `ADR-0004`, `ADR-0005`, `ADR-0014`, `ADR-0015`, `ADR-0017`, `ADR-0018` (Propuesto) | Criterios de `RF-02`, ajustados para probar asignación inicial y rechazo de cambios; pruebas de autorización. | Identidad y roles validados en [Diseño detallado de identidad y acceso](phase-2-detailed-design-identity-access.md); perfil propuesto en [Diseño detallado de gestión de corredores](phase-2-detailed-design-runner-management.md), bloqueado por `ADR-0018`; taxonomías pendientes |
...
| `ADR-0018`: ciclo de vida, inactividad y reactivación del corredor | Perfil mínimo, permisos, elegibilidad, retención automática durante 24 meses y reactivación revisada. | Diseño de `runner-management` y producción. | Revisor de arquitectura y Revisor de privacidad o DPO | Propuesto; decisiones de producto cerradas, pendiente validar base jurídica, necesidad y proporcionalidad antes de aceptar. |
