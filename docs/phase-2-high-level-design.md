...
| `RF-15` | Publicación y Entrega de notificaciones | Una sesión local puede cambiar varios días futuros y los confirma como una versión completa y una solicitud por destinatario congelado; cada intento exige elegibilidad `active`. | `D-06` | `ADR-0007`, `ADR-0008`, `ADR-0020` (Aceptados), `ADR-0021` (Propuesto) | Criterios de `RF-15`; pruebas temporales, varios días, versión única, grupo inactivo, atomicidad, actividad y notificación. | Diseñado en [publicación](phase-2-detailed-design-publication.md); entrega base aceptada y elegibilidad pendiente de validar |
...
| `RF-20` | Publicación y Entrega de notificaciones | Cada versión genera una solicitud individual por destinatario congelado; antes de cada intento se omite al inactivo. La reactivación no reabre solicitudes omitidas, pero habilita las de versiones futuras. | `D-06` | `ADR-0007`, `ADR-0008`, `ADR-0011` (Aceptados), `ADR-0021` (Propuesto) | Criterios de `RF-20`; pruebas de contenido, actividad, omisión, reactivación, atomicidad, orden y carrera con baja. | Diseñado en [publicación](phase-2-detailed-design-publication.md); pendiente validar `ADR-0021` y controles previos a producción |
...
| `D-06` | Borrador solo antes de publicar; después, sesión local y sustitución atómica de días futuros, versiones completas, solicitudes para destinatarios congelados y entrega condicionada a actividad actual. | `ADR-0007`, `ADR-0008`, `ADR-0011`, `ADR-0020` (Aceptados), `ADR-0021` (Propuesto) |
