...
| `RF-04` | Planificación; Clasificación y segmentación | Modalidad como etiqueta y ubicación libre solo cuando corresponda. | `D-02`, `D-04` | `ADR-0005`, `ADR-0006` (Aceptado), `ADR-0019` | Criterios de `RF-04`; pruebas de valores permitidos y ubicación. | Aportación de clasificación diseñada y validada; diseño detallado de planificación pendiente |
...
| `RF-08` | Clasificación, Planificación y Publicación | Un grupo combina segmentos e inclusiones o exclusiones persistentes; la primera publicación congela sus miembros para todas las versiones del plan. | `D-01` | `ADR-0005` (Aceptado), `ADR-0006` (Aceptado), `ADR-0007` (Aceptado), `ADR-0019` | Criterios de `RF-08`; pruebas de fórmula del grupo, referencias, exclusividad y captura al publicar. | Coordinación desde clasificación diseñada y validada; diseños detallados de planificación y publicación pendientes |
| `RF-09` | Publicación | Validar, versionar y activar plan y destinatarios dentro de una única transacción. | `D-01`, `D-06` | `ADR-0007` (Aceptado), `ADR-0019` (Aceptado) | Criterios de `RF-09`; pruebas de fallo sin visibilidad parcial y carreras con mutaciones de clasificación. | Garantía de coordinación desde clasificación diseñada y validada; diseño detallado de publicación pendiente |
| `RF-10` | Publicación | Cada publicación conserva contenido inmutable y el conjunto de destinatarios congelado en la primera versión. | `D-01`, `D-06` | `ADR-0007` (Aceptado), `ADR-0019` (Aceptado) | Criterios de `RF-10`; pruebas ante cambios posteriores del borrador, grupo o clasificación. | Inmutabilidad frente a clasificación diseñada y validada; diseño detallado de publicación pendiente |
...
| --- | --- | --- |
| `D-01` | Taxonomías, segmentos solapables, grupos exclusivos, excepciones e instantáneas de versión y destinatarios efectivos. | `ADR-0005` (Aceptado), `ADR-0006` (Aceptado), `ADR-0007` (Aceptado), `ADR-0019` (Aceptado) |
| `D-02` | Modalidad dentro de la taxonomía controlada. | `ADR-0005` (Aceptado), `ADR-0019` (Aceptado) |
