...
| `RF-08` | Clasificación, Planificación y Publicación | Un grupo activo combina segmentos e inclusiones o exclusiones persistentes; una reconfiguración multigrupo protege traslados y la primera publicación congela miembros. | `D-01` | `ADR-0005` (Aceptado), `ADR-0006` (Aceptado), `ADR-0007` (Aceptado), `ADR-0019` (Aceptado), `ADR-0020` (Aceptado) | Criterios de `RF-08`; pruebas de fórmula, estados de grupo, reconfiguración, exclusividad y captura al publicar. | Clasificación y planificación validadas; diseño detallado de publicación pendiente |
| `RF-09` | Publicación | Validar, versionar y activar plan y destinatarios dentro de una única transacción con coordinación de grupos y revisión del borrador. | `D-01`, `D-06` | `ADR-0007` (Aceptado), `ADR-0019` (Aceptado), `ADR-0020` (Aceptado) | Criterios de `RF-09`; pruebas de fallo sin visibilidad parcial y carreras con clasificación, grupos o borrador. | Garantías de clasificación y planificación validadas; diseño detallado de publicación pendiente |
| `RF-10` | Publicación | Cada publicación conserva contenido inmutable, nombre de grupo congelado y destinatarios congelados desde la primera versión. | `D-01`, `D-06` | `ADR-0007` (Aceptado), `ADR-0019` (Aceptado), `ADR-0020` (Aceptado) | Criterios de `RF-10`; pruebas ante cambios posteriores del borrador, nombre de grupo o clasificación. | Aportación de planificación validada; diseño detallado de publicación pendiente |
...
| `RF-14` | Planificación y Publicación | Estados visibles borrador/publicado; revisión única, borrador separado, cambios pendientes derivados y restauración desde versión activa. | `D-06` | `ADR-0006` (Aceptado), `ADR-0007` (Aceptado), `ADR-0020` (Aceptado) | Criterios de `RF-14`; pruebas de transiciones, concurrencia, restauración y cambios pendientes. | Planificación validada; diseño detallado de publicación pendiente |
| `RF-15` | Publicación y Entrega de notificaciones | Todo cambio visible exige una republicación completa; un grupo inactivo permite republicar solo para destinatarios ya congelados. | `D-06` | `ADR-0007` (Aceptado), `ADR-0008` (Aceptado), `ADR-0020` (Aceptado) | Criterios de `RF-15`; pruebas de versión, cambios relevantes, grupo inactivo, atomicidad y notificación. | Frontera de planificación validada; diseños detallados de publicación y entrega pendientes |
...
| `D-06` | Borrador con revisión global, republicación atómica, versiones completas, destinatarios congelados y solicitud transaccional de correo. | `ADR-0007` (Aceptado), `ADR-0008` (Aceptado), `ADR-0011` (Aceptado), `ADR-0020` (Aceptado) |
