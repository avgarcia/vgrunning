...
| `RF-15` | Publicación y Entrega de notificaciones | Una sesión local puede cambiar varios días futuros y los confirma como una versión completa y una solicitud por destinatario congelado; cada intento exige elegibilidad `active`. | `D-06` | `ADR-0007`, `ADR-0008`, `ADR-0020`, `ADR-0021` (Aceptados) | Criterios de `RF-15`; pruebas temporales, varios días, versión única, grupo inactivo, atomicidad, actividad y notificación. | Aportación de publicación validada; diseño detallado de entrega pendiente |
